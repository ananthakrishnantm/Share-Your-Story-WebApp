...
const Registration = () => {
  ...
  const handleSubmitSignup = (e) => {
    ...
    axios
      ...
      .then(() => {
        navigate("/EmailVerification-Sent");
      })
      .catch((err) => {
        console.log(err);
      });
          ...
          <div>
            ...
            <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
              <div className="pb-2 pt-2 flex flex-col">
                <label className="text-left mb-2">Enter your Name</label>
              ...
              <div className="pb-2 pt-2 flex flex-col">
                <label className="text-left mb-2">Enter username</label>
                <label className="input bg-info-content flex items-center gap-2 focus-within:border-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
              ...
              <div className="pb-2 pt-2 flex flex-col">
                <label className="text-left mb-2">Enter your mail Id</label>
                <label className="input bg-info-content flex items-center gap-2 focus-within:border-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 16 16"
              ...
              <div className="px-4 pb-2 pt-4">
                <button
                  ...
                  className="uppercase block w-full p-4 text-lg font-bold rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none mt-5"
                >
                  Register
                </button>
              </div>
