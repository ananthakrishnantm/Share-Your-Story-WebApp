...
const DashboardBListMain = () => {
  ...
  const fetchreport = async () => {
    try {
      const path = `/profile/users/banned`;
  ...
  console.log("this is hte banned thing", bannedUsers);
  ...
  return (
    <main className="flex-1 p-6">
      <h2 className="text-3xl font-semibold text-gray-800 mb-6">BlockedList</h2>
      <div className="mb-2">
        {/* Start coding here */}
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center">
                    <img
                      ...
                      };base64,${Buffer.from(user.profilePicture.data).toString(
                        "base64"
                      )}`}
                      alt={user.username}
                    />
...
export default DashboardBListMain;
